    ...
    function initStickerSystem() {
        ...
        if (tabBar) {
            ...
            newTabBar.addEventListener('click', (e) => {
                // 查找最近的 .sticker-settings-tab 或 .sticker-add-tab
                const manageBtn = e.target.closest('#sticker-manage-btn');
                const addBtn = e.target.closest('#sticker-add-btn');
        ...
        if (selectAllBtn) {
            selectAllBtn.addEventListener('click', toggleSelectAllStickers);
        }

        // 绑定删除按钮
        const deleteBtn = document.getElementById('sticker-delete-btn');
        if (deleteBtn) {
            deleteBtn.addEventListener('click', deleteSelectedStickers);
        }
        ...
        if (saveImportBtn) {
            saveImportBtn.addEventListener('click', handleImportStickers);
        }
